...
void MainActivityProcess::getCameraFramesFlow() {
	...
	while (cap[0].isOpened() && cap[0].isOpened()) {
		...
		goodFeaturesToTrack(rect_gray_frame0, this->good_points[0], this->fd_parametrs.max_сorners
			, this->fd_parametrs.quality_level, this->fd_parametrs.min_distance, Mat(), this->fd_parametrs.block_size, 0, this->fd_parametrs.k);

		goodFeaturesToTrack(rect_gray_frame1, this->good_points[1], this->fd_parametrs.max_сorners
			, this->fd_parametrs.quality_level, this->fd_parametrs.min_distance, Mat(), this->fd_parametrs.block_size, 0, this->fd_parametrs.k);
